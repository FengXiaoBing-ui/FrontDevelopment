    ...
    <view>
        ...
        <view class="whiteBoxShadow margin-sm">
            ...
            <view class="flex justify-between align-center margin-top">
                <view>
                    <view class="text-red text-bold margin-tb-sm">返佣商品</view>
        ...
        <u-popup :closeable="true" :round="10" :show="showPop" mode="bottom" @close="close">
            ...
            <view style="height: 80vh;overflow: scroll"  class="padding-lr margin-top bg-white radius">
...
export default {
    ...
    data() {
        return {
            ...
            applyInfo: [
                { label: "返佣方式", value: "商品返佣" },
                { label: "返佣商品", value: "东方国宾·尊致" },
                { label: "返佣数量", value: "600瓶" },
