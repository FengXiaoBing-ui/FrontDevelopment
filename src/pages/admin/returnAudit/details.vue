<template>
    <view class="content">
        ...
        <view class="padding-lr-sm padding-tb"
              :style="'margin-top:' + CustomBar + 'px;'+(status==3||status==4||status==5?'padding-bottom:120rpx':'')">
            <view class="whiteBoxShadow">
                <view class="flex align-center justify-between">
                    ...
                    <text class="text-orange">
                        ...
                        {{ status == 1 ? "待审核" : status == 2 ? "未通过" : status == 3||status==4||status==5? "进行中" : "已完成" }}
                    </text>
                </view>
            ...
            <view v-if="status==3||status==4" class="whiteBoxShadow margin-top-sm">
            ...
            <view v-if="status==5" class="whiteBoxShadow margin-top-sm">
                <boxTitle title="物流信息"></boxTitle>
                <view class="text-df text-red margin-top-sm">您已同意退货，等待代理商将产品退回</view>
            </view>
            <!--售后信息-->
            ...
            <view v-if="status==3||status==4||status==5" class="botBtn padding bg-white">
        ...
        <view v-if="status==1" class="flex foot bg-white padding justify-between">
            <view class="cu-btn w50 bg-gray margin-right-sm radius">驳回申请</view>
