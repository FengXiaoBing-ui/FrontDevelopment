    ...
    <view>
        ...
        <view :style="`margin-top:${(CustomBar+10)*2}rpx`">
            <view class="whiteBoxShadow  margin-lr-sm flex align-center justify-between">
                ...
                <view class="text-red">{{status==='2'?'进行中':'已完成'}}</view>
            </view>
        </view>
        ...
        <view class="whiteBoxShadow margin-sm ">
            <boxTitle :right-text="status==='2'?'查看订单记录':''" :right-text-class="status==='2'?'cu-btn xs':''" title="九月订单统计"></boxTitle>
        ...
        <view class="margin-sm whiteBoxShadow" >
            ...
            <view v-for="(item,index) in backInfo" :key="index"
                  class="flex margin-top-sm justify-between align-center">
    ...
    data() {
        return {
            ...
            applyInfo: [
                ...
                { label: "审核状态", value: "已通过" },
                { label: "审核人", value: "王丽" },
                { label: "审核时间", value: "2022-08-30 12:26:56" },
                { label: "完成时间", value: "2022-08-30 12:26:56" }
            ],
            info: {
