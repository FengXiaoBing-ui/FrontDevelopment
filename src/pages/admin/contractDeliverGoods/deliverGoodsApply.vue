            ...
            <view class="padding-lr contentBox">
                ...
                <view class="product margin-top-sm">
                    <view class="flex flex-wrap justify-between">
                        <view @click="jumpDetails" v-for="(item,index) in productList" :key="index" style="width: 100%" class="whiteBoxShadow margin-top-sm">
...
export default {
    ...
    methods: {
        ...
        jumpDetails(){
            uni.navigateTo({
                url:"/pages/admin/contractDeliverGoods/deliverGoodsToExamine?status="+this.statusIndex
            })
        }
    }
};
