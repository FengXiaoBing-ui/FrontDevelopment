<template>
    <view class="content" style="padding-bottom: 100rpx">
        ...
        <view class="margin-top-sm">
            ...
            <investor @click.native="gotoPath(1)" title="合作协议列表" v-show="activeText==='合作协议'"></investor>
        </view>

        <view class="fixed bg-white padding-xs w100">
            <button class="cu-btn bg-red radius w100">统一发货</button>
        </view>
...
export default {
    ...
    methods:{
        ...
        gotoPath(status){
            uni.navigateTo({
                url: "/pages/admin/tender/details?status="+status
            });
        },
        gotoVideo() {
            //#ifdef APP_PLUS
