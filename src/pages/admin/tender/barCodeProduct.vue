  ...
  <view class="content">
    <u-navbar :border="false" :fixed="true" :autoBack="true"
      ...
      <view slot="center" class="u-nav-slot">
        <view class="text-xl text-bold">条码商品管理</view>
            ...
            <view class="margin-top">
              ...
              <view class="flex justify-between align-center margin-top">
                <view class="flex align-center text-sm">
                  ...
                  <view class="text-orange">21000瓶</view>
                </view>
                <view class="flex align-center text-sm">
                  <view class="cuIcon-recharge"></view>
                  <view class="margin-lr-xs">当前成交额：</view>
                  <view class="text-red">¥6000000.00</view>
                </view>
              </view>
            </view>
          </view>
...
export default {
  ...
  methods: {
    ...
    goTo(status){
      uni.navigateTo({
        url: "/pages/admin/tender/commodityManagement?status=" + status
      });
    },
  },
};
