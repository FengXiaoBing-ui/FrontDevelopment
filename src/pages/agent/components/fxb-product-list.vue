    ...
    <view>
        <view style="width: 100%" class="productList bg-white padding-sm shadow-warp">
            <view class="flex">
                ...
                <view class="flex flex-direction margin-left w420">
                    <text @click="jumpDetail" class="beyond margin-bottom-sm text-black">
                        {{ title }}
                    </text>
                    <text class="beyond text-gray text-sm">{{ infoText }}</text>
                    <view class="flex align-center margin-top-sm">
                        <button class="cu-btn line-blue sm" @click="jumpDetail">商品详情</button>
                        <button class="cu-btn line-blue margin-left-sm sm" @click="lookInfo(1)">参考数据</button>
                    </view>
                    <view class="flex justify-between padding-tb-sm" @click="jumpPay">
                        <text class="text-red text-bold text-sm">零售价:￥{{ price }}</text>
                        <text class="text-gray text-sm"
                            >代理价:<text class="text-red bg-gray radius margin-left-sm" style="padding: 3px 6px">会员可见</text>
                        </text>
                    </view>
                </view>
            </view>
            <view class="flex justify-between margin-top-sm">
                <view class="text-sm">剩余代理人：<text class="text-red">23人</text></view>
                <button class="bg-grey cu-btn sm" @click="applySample">申请样品</button>
                <button class="bg-red cu-btn sm" @click="jumpAgentProducts">我要代理</button>
            </view>
        </view>
            ...
            <view v-show="lookInfoState == 1" class="productParameter bg-white padding-tb-lg padding-lr-sm">
                ...
                <view class="margin-tb">
                    <view class="flex align-center">
                        <view style="width: 8rpx; height: 30rpx; border-radius: 10rpx" class="bg-red margin-right-sm"></view>
                    ...
                    <view>
                        <view class="flex padding-sm align-center showType">
                            ...
                            <u-tag size="mini" class="margin-left-sm" text="走势图" :plain="showType!=='2'" @click="changeType('2')"
                                   type="error"></u-tag>
                        </view>
                    </view>
                    <view>
